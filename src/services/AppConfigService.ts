...
export const AppConfigService = {
  ...
  update: async (key: string, request: AppConfigRequest): Promise<AppConfig> => {
    ...
    const res = await axios.put<AppConfig>(`${BASE_URL}/${key}`, request);
    return res.data;
  },
